        ...
        <Container className="relative z-10">
          <FadeIn className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl" style={{ color: 'var(--text-secondary)' }}>
              We&apos;re on a mission to build technology that empowers people
              and transforms ideas into impactful digital experiences.
            </p>
          </FadeIn>
        </Container>
      </section>
            ...
            <FadeIn>
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <p
                  ...
                  style={{ color: 'var(--text-secondary)' }}
                >
                  We then turned our attention to the small businesses and
                  individuals who needed powerful document tools without the
                  cost or complexity. Scanvo was born — a free Android app that
                  turns any phone into a full-featured document scanner with ID
                  card mode, batch scanning, and PDF export, all processed 100%
                  offline on-device to keep your documents private.
                </p>
                <p
                ...
                >
                  ...
                  portfolio — from tools like PhotoPrint Pro for instant
                  passport photos to Job Automator for hands-free job
                  applications. With each new project, we stay true to our core
              ...
              <Card className="h-full p-8" gradient>
                <div className="flex items-center gap-4 mb-6">
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(to bottom right, var(--accent-purple), var(--accent))',
                      opacity: 0.9,
                    }}
                  >
