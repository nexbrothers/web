          ...
          <div className="max-w-3xl mx-auto">
            <FadeIn>
              ...
              <p
                ...
                style={{ color: 'var(--text-secondary)' }}
              >
                Upload any photo. Get a print-ready passport photo sheet in
                seconds. Auto background removal, face detection, and perfect
                sizing — completely free. 300 DPI print quality, no signup
                required.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="https://photoprint-pro.shop/"
                  target="_blank"
              ...
              >
                ...
                <div className="p-4">
                  <p
                    ...
                    style={{ color: 'var(--text-secondary)' }}
                  >
                    Photo Maker — Upload, configure settings, and generate
                    print-ready photos
                  </p>
                </div>
              </div>
          ...
          <FadeIn>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p
                ...
                style={{ color: 'var(--text-secondary)' }}
              >
                Join users who are already saving time and money with PhotoPrint
                Pro. Remove backgrounds, arrange layouts, and print in seconds.
              </p>
              ...
              <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
                100% Free • No signup required • 300 DPI quality • Works on any
                device
              </p>
            </div>
          </FadeIn>
