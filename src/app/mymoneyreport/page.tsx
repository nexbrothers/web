        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <FadeIn>
            <div className="rounded-2xl p-1" style={{ background: `linear-gradient(135deg, ${MMR_PURPLE}30, transparent)` }}>
              <div className="rounded-xl overflow-hidden" style={{ backgroundColor: "#0D1117" }}>
                <div className="p-5 space-y-1">
                  ...
                  <div className="flex justify-between items-center mt-4 pt-3" style={{ borderTop: "1px solid #1F2937" }}>
                    ...
                    <span className="text-xs" style={{ color: MMR_PURPLE }}>
                      More Options +
                    </span>
                  </div>
                </div>
              ...
              <div className="rounded-xl overflow-hidden" style={{ backgroundColor: "#0D1117" }}>
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-center mt-3 pt-3" style={{ borderTop: "1px solid #1F2937" }}>
                    <span className="text-xs" style={{ color: "#94A3B8" }}>Total 7 Transactions</span>
  ...
  return (
    <section id="sms-tracking" className="py-24 relative overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <FadeIn>
            <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: "#0D1117", border: "1px solid #1F2937" }}>
              <div className="p-5 space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-white font-semibold text-sm">SMS Tracking</h3>
                  <div className="flex items-center gap-2">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <FadeIn>
            <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: "#0D1117", border: "1px solid #1F2937" }}>
              <div className="p-5">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-white font-semibold">Monthly Budgets</h3>
                    ...
                    return (
                      <div key={cat.name}>
                        <div className="flex justify-between text-xs mb-1">
                          ...
                          <span style={{ color: "#94A3B8" }}>₹ {cat.spent.toLocaleString()} / ₹ {cat.budget.toLocaleString()}</span>
                        </div>
      ...
      <Container className="relative z-10">
        ...
        <div className="grid lg:grid-cols-5 gap-6">
          <FadeIn className="lg:col-span-3">
            <div className="rounded-2xl overflow-hidden h-full" style={{ backgroundColor: "#0D1117", border: "1px solid #1F2937" }}>
              <div className="p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-end gap-2 h-28 px-4">
                    {[
                      ...
                      <div key={i} className="flex flex-col items-center gap-1">
                        ...
                        <span className="text-[10px]" style={{ color: "#94A3B8" }}>{month.label}</span>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <FadeIn>
            <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: "#0D1117", border: "1px solid #1F2937" }}>
              <div className="p-5">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-white font-semibold text-sm">Trip to Goa</h3>
      ...
      <Container className="relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <FadeIn className="text-center mt-10">
            <Link
              href="/mymoneyreport/privacypolicy"
      ...
      <Container className="relative z-10 text-center">
        <FadeIn>
          <div className="max-w-2xl mx-auto">
            ...
            >
              <Image
                src="/images/my-money-report-logo.png"
                alt="My Money Report"
                width={80}
                height={80}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/mymoneyreport/privacypolicy">
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        <FadeIn>
          <div className="max-w-3xl mx-auto overflow-hidden rounded-2xl" style={{ backgroundColor: "#0D1117", border: "1px solid #1F2937" }}>
...
export default function MyMoneyReportPage() {
  return (
    <>
      <ProgressBar />
      <HeroSection />
      <section className="py-6 text-center border-b" style={{ backgroundColor: "var(--background)", borderColor: "var(--border)" }}>
        <Container>
          <Link href="/" className="inline-flex items-center gap-1.5 text-xs font-medium hover:opacity-80 transition-opacity" style={{ color: "var(--text-muted)" }}>
